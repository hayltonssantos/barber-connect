...
const removeFuncionario = useCallback(async (id: string): Promise<void> => {
  ...
  const updateCliente = useCallback(async (): Promise<void> => {
    if (!contribuinte) throw new Error('Contribuinte não definido');
  ...
  const removeCliente = useCallback(async (): Promise<void> => {
    if (!contribuinte) throw new Error('Contribuinte não definido');
  ...
  const addServico = useCallback(async (): Promise<string> => {
    if (!contribuinte) throw new Error('Contribuinte não definido');
  ...
  const updateServico = useCallback(async (): Promise<void> => {
    if (!contribuinte) throw new Error('Contribuinte não definido');
  ...
  const removeServico = useCallback(async (): Promise<void> => {
    if (!contribuinte) throw new Error('Contribuinte não definido');
  ...
  const updateAgendamento = useCallback(async (): Promise<void> => {
    if (!contribuinte) throw new Error('Contribuinte não definido');
  ...
  const cancelAgendamento = useCallback(async (): Promise<void> => {
    if (!contribuinte) throw new Error('Contribuinte não definido');
