...
import { BarbeariaService } from '@/services/barbeariaService'; // ✅ VERIFICAR ESTA IMPORTAÇÃO
...
console.log('🔧 BarbeariaService importado:', BarbeariaService);
console.log('🔧 Método verificarContribuinte:', BarbeariaService.verificarContribuinte);
  ...
  try {
    ...
    if (barbeariaExists) {
      console.log('✅ Barbearia existe - indo para login');
      navigate('/login', { 
        state: { contribuinte: form.contribuinte, exists: true }
      });
    } else {
      console.log('➕ Barbearia não existe - indo para login para depois configurar');
      navigate('/login', { 
        state: { contribuinte: form.contribuinte, exists: false }
      });
    }
