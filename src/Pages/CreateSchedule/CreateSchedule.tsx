...
import dayjs from 'dayjs'; // ✅ ADICIONAR ESTA IMPORTAÇÃO
import type { Agendamento, FormErrors } from '@/types';
...
}, [form.data, form.funcionarioId, selectedServicos, barbearia]); // ✅ Adicionar barbearia como dependência

const generateAvailableTimeSlots = () => {
  if (!form.data || !barbearia) return;

  // ✅ USAR DAYJS CORRETAMENTE
  const selectedDate = dayjs(form.data); // ✅ Agora dayjs está importado
  
  // Verificar se é dia de funcionamento
  if (!isWorkingDay(selectedDate, barbearia.horarioFuncionamento.diasFuncionamento)) {
