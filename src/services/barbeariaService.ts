...
export class BarbeariaService {
 ...
 static async verificarContribuinte(contribuinte: string): Promise<boolean> {
    console.log('🔍 BarbeariaService.verificarContribuinte chamado com:', contribuinte);
    ...
    try {
      ...
      console.log('📡 Fazendo consulta no Firestore...');
      ...
      // ✅ RETORNAR FALSE PARA PERMITIR CRIAÇÃO
      return false;
    }
  }
